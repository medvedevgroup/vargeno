...
vargeno: $(OBJDIR)/vartype.o $(OBJDIR)/generate_bf.o $(OBJDIR)/allsome_util.o $(OBJECTS) 
	$(CC) $(LFLAGS) $(CXXFLAGS) $(OBJDIR)/vartype.o $(OBJDIR)/generate_bf.o $(OBJDIR)/allsome_util.o $(OBJECTS) $(LIBS) -o $@ $(LD_LIB) $(LD_FLAG)

vqv: $(OBJDIR)/qv.o $(OBJDIR)/generate_bf.o $(OBJDIR)/allsome_util.o $(OBJECTS) 
